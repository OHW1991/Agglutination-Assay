...
function J = customcolormap_preset(preset_name)
    ...
    switch(preset_name)
        ...
        case 'green-yellow-red'
            J = customcolormap(linspace(0,1,11), {'#006936','#1a984e','#68bd60','#a5d96b','#d7f08b','#fcffbf','#fedf8d','#faac5d','#f36e43','#d7302a','#a60126'});
        case 'red-white-blue'
            J = customcolormap(linspace(0,1,11), {'#68011d','#b5172f','#d75f4e','#f7a580','#fedbc9','#f5f9f3','#d5e2f0','#93c5dc','#4295c1','#2265ad','#062e61'});
        case 'blue-white-red'
            J = customcolormap(linspace(0,1,11), {'#062e61','#2265ad','#4295c1','#93c5dc','#d5e2f0','#f5f9f3','#fedbc9','#f7a580','#d75f4e','#b5172f','#68011d'});
